...
with_node \
  ...
  --target "/Users/juliozambom/Documents/projects/cars/ios/Pods/Target Support Files/Pods-reactnativeboilerplate/ExpoModulesProvider.swift" \
  --entitlement "/Users/juliozambom/Documents/projects/cars/ios/reactnativeboilerplate/reactnativeboilerplate.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-asset" "expo-blur" "expo-constants" "expo-dev-launcher" "expo-dev-menu" "expo-file-system" "expo-font" "expo-haptics" "expo-keep-awake" "expo-linking" "expo-router" "expo-splash-screen" "expo-symbols" "expo-system-ui" "expo-web-browser" "sweet-sfsymbols"
